...
<body class="bg-white">
    <div class="p-4">
        <h1 class="text-2xl font-semibold text-secondary2">Terima kasih, {{ $userName }}!</h1>
        <p class="text-lg">Pesanan Anda telah diterima.</p>
        <p class="text-lg">Tanggal Mulai: {{ $pickup }}</p>
        <p class="text-lg">Tanggal Selesai: {{ $return }}</p>
