...
<x-app-layout bodyClass="bg-tertiery3 text-tertiery1">
    <div class="container mt-[5rem] md:mt-8 mx-auto my-8">
        <div class="fixed bottom-5 sm:hidden px-2 w-full z-50">
            <div class="flex gap-2 alert alert-info">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-info-circle size-5" viewBox="0 0 16 16">
        ...
        <form class="bg-white p-6 rounded-xl" action="{{ route('admin.report') }}" method="GET">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="card bg-base-100 drop-shadow p-4">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <input type="hidden" name="total_rents" value="{{ $totalRents }}">
                        </div>
                ...
                <div class="card bg-base-100 drop-shadow p-4">
                    <div class="flex justify-between items-center">
                        <div>
                            <h2 class="text-lg font-semibold">Product Quantity Rented</h2>
                            <p class="text-xl md:text-3xl font-bold">{{ $quantityRentTotal }}</p>
                            <input type="hidden" name="quantity_rented_product" value="{{ $quantityRentTotal }}">
                        </div>
