    ...
    <x-slot name="scripts">
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                let currentIndex = 0;
                let totalSlides = Math.ceil(slides.children.length / (window.innerWidth >= 1024 ? 4 : 1)); // Hitung total slide
                let slideInterval;
                ...
                function updateCarousel() {
                    const offset = -currentIndex * (window.innerWidth >= 1024 ? 100 : 100); // Geser slide berdasarkan indeks
